...
public class AnimalsSuckingAtJumping {
	public static void main(String[] args) throws MalformedURLException {
		...
		String urlOfAnimalSuckingAtJumping = "http://67.media.tumblr.com/e2f247bbf55e584b5cd5416e064643c4/tumblr_n5b6a4jA3v1s612eao1_400.gif";
		JFrame frame = new JFrame("Lift Me!");
		frame.setVisible(true);
		JLabel label = createImage("http://67.media.tumblr.com/e2f247bbf55e584b5cd5416e064643c4/tumblr_n5b6a4jA3v1s612eao1_400.gif");
		frame.add(label);
		frame.pack();
