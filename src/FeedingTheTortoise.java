...
public class FeedingTheTortoise implements KeyEventDispatcher
{

	// 1. Decide where to put the food by setting these variables
	
	int foodLocationX = 600;
	int foodLocationY = 500;
	...
	{
		FeedingTheTortoise feeder = new FeedingTheTortoise();
