...
public class Backpack {
	...
	public static void main(String[] args) {
		...
		Backpack geoffrey = new Backpack();
		Textbook harold = new Textbook();
		Pencil jerry = new Pencil();
		Ruler georger = new Ruler();
		geoffrey.putInBackpack(harold);
		geoffrey.putInBackpack(jerry);
		geoffrey.putInBackpack(georger);
		geoffrey.goToSchool();
